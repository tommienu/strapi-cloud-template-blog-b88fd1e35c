...
export interface ApiRecipeRecipe extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    aggregateRating: Schema.Attribute.Component<'recipe.rating', false>;
    author: Schema.Attribute.Relation<'manyToOne', 'api::author.author'>;
    ...
    recipeIngredient: Schema.Attribute.Component<'recipe.ingredient', true> &
      Schema.Attribute.Required;
    recipeInstructions: Schema.Attribute.Component<'recipe.instruction', true> &
      Schema.Attribute.Required;
    recipeYield: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    video: Schema.Attribute.Component<'recipe.video', false>;
  };
}
